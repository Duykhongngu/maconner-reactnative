...
function Drinkware() {
  ...
  const drinkWare = Array.isArray(products.drinkWare) ? products.drinkWare : [];
  const totalPages = Math.ceil(drinkWare.length / itemsPerPage);

  const paginatedProducts = drinkWare.slice(
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: bgColor }]}>
      <ScrollView>
        <View style={styles.content}>
          <Text style={[styles.title, { color: "#F97316" }]}>Drink Ware</Text>
          {drinkWare.length > 0 ? (
            <>
